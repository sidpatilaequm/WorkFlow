...
def create_workflow(
    ...
    wf = models.Workflow(
        ...
        message_variables=[mv.dict() for mv in payload.message_variables] if payload.message_variables else None,
    ...
    if stages_data is not None:
        ...
        for s in stages_data:
            db.add(models.WorkflowStage(
                ...
                approve_label=s.get("approve_label"),
                reject_label=s.get("reject_label"),
